...
PROTOTXT=examples/feature_extraction/imagenet_val.prototxt # 网络定义
LAYER=conv1 # 提取层的名字，如提取fc7等
LEVELDB=examples/_temp/feat_conv1 # 保存的leveldb路径
BATCHSIZE=10
...
$TOOL/extract_features.bin  $MODEL $PROTOTXT $LAYER $LEVELDB $BATCHSIZE leveldb

...
import os
if not os.path.isfile(caffe_root + 'models/idface/deepid_28_0_train_iter_80000'):
...
itransformer.set_raw_scale('data', 255)  # the reference model operates on images in [0,255] range instead of [0,1]
